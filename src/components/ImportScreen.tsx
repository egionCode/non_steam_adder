    ...
    <div class="flex-1 flex flex-col items-center justify-center p-10 animate-in fade-in slide-in-from-bottom-6 duration-700 ease-[cubic-bezier(0.2,0.8,0.2,1)]">
      <div class="text-center mb-[clamp(2rem,10vh,4rem)]">
        ...
        <p class="text-steam-text-muted text-xl max-w-lg mx-auto leading-relaxed">
          Bring your DRM-free collection together with official artwork and seamless integration.
        </p>
      </div>
      ...
      >
        <div class={`absolute inset-0 bg-radial-[circle_at_center,rgba(102,192,244,0.03)_0%,transparent_70%] transition-opacity duration-700 ${props.isDragging ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}></div>
        ...
        <div class="text-center relative z-10">
          <p class="text-white font-black text-2xl mb-2 tracking-tight uppercase">Import Game Executable</p>
          <p class="text-steam-text-muted font-medium">Click to browse or drop your <span class="text-steam-blue font-bold">.exe</span> here</p>
        </div>

        <div class="absolute bottom-8 left-0 right-0 flex justify-center">
          <span class="text-[10px] text-steam-blue/30 uppercase font-black tracking-[0.3em] bg-steam-bg-dark/40 px-4 py-1.5 rounded-full border border-white/5">
            Steam Engine Extension
          </span>
        </div>
      </div>
    </div>
